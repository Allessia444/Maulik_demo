...
<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
	<div class="min-height-200px">
		...
		<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
			{!! Former::open()->method('PATCH')->action(route('blogs.update',$blogs->id)) !!}
			@csrf
			{!! Former::select('blog_category_id')->class('form-control')->options($blog_categories)->select($blogs->blog_category_id) !!}

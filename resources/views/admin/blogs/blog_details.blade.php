			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					...
					<nav aria-label="breadcrumb" role="navigation">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="{!! route('guest_user') !!}">Home</a></li>
							<li class="breadcrumb-item"><a href="{!! route('guest_user') !!}">Blogs</a></li>
				...
				<div class="row">
					<div class="col-md-8 col-sm-12">
						<div class="blog-detail mb-30">
							<div class="blog-img">
								<img src="{!! $blog->blog_photo_url('thumb') !!}" alt="">
							</div>
